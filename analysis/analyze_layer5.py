"""
Systematic Analysis of Layer 5 (Emotional-Psychological Representation) Results
================================================================================

This script performs comprehensive analysis of Layer 5 evaluation data.
...
df = load_layer_data(layer=5)

print("=" * 100)
print("LAYER 5 (EMOTIONAL-PSYCHOLOGICAL REPRESENTATION) - SYSTEMATIC ANALYSIS")
print("=" * 100)
...
# ========================================
# 11. LAYER 4 vs LAYER 5 COMPARISON
# ========================================
print("\n" + "=" * 100)
print("11. CROSS-LAYER COMPARISON (Layer 4 vs Layer 5 vs Layer 6)")
print("=" * 100)

# Load Layer 4 and Layer 6 data for comparison
df4 = load_layer_data(layer=4)
df6 = load_layer_data(layer=6)

layer_pairs = [("Layer 4", "Layer 5", df4, df), ("Layer 4", "Layer 6", df4, df6), ("Layer 5", "Layer 6", df, df6)]
