...
% Define custom text box styles for prompts
\tcbuselibrary{skins,breakable}
\definecolor{promptbg}{RGB}{240,248,255} % Light blue background (Alice Blue)
\definecolor{promptborder}{RGB}{100,149,237} % Cornflower blue border
...
\pdfinfo{
/Title (SAGE: Hierarchical LLM-Based Literary Evaluation through Theory-Grounded Interpretive Dimensions)
/Author (Anonymous)}
...
%
\title{SAGE: Hierarchical LLM-Based Literary Evaluation\\through Theory-Grounded Interpretive Dimensions}
% \title{An Ontology-based Framework for Literary Evaluation with Large Language Models}
